...
})(PS["AnimationNames"] = PS["AnimationNames"] || {});
(function(exports) {
...
(function(exports) {
  ...
  var isStringAnimationName = new CSS_String.IsString(function ($73) {
      return AnimationName(CSS_String.fromString(CSS_Property.isStringValue)($73));
  });
...
(function(exports) {
  ...
  // | FillModes
  var none = CSS_Animation.FillMode(CSS_String.fromString(CSS_Property.isStringValue)("none"));

  // | TimingFunctions
  var easeInOut = CSS_Transition.TimingFunction(CSS_String.fromString(CSS_Property.isStringValue)("ease-in-out"));
...
(function(exports) {
  ...
  var Data_NonEmpty = PS["Data.NonEmpty"];
  var Prelude = PS["Prelude"];                 
  var springWidth = CSS_Geometry.width(CSS_Size.em(0.1));
  ...
  exports["springMotion"] = springMotion;
...
(function(exports) {
  ...
  var transition = function (p) {
      return function (d) {
          return function (f) {
              return function (e) {
                  return CSS_Stylesheet.prefixed(CSS_Property.valTuple(CSS_Property.valString)(CSS_Property.valTuple(CSS_Time.valTime)(CSS_Property.valTuple(CSS_Transition.valTimingFunction)(CSS_Time.valTime))))(Data_Semigroup.append(CSS_Property.semigroupPrefixed)(CSS_Common.browsers)(CSS_String.fromString(CSS_Property.isStringPrefixed)("transition")))(new Data_Tuple.Tuple(p, new Data_Tuple.Tuple(d, new Data_Tuple.Tuple(f, e))));
              };
          };
      };
  };
  ...
  var after = CSS_String.fromString(CSS_Selector.isStringRefinement)("::after");
...
(function(exports) {
  ...
  var CSS_Time = PS["CSS.Time"];
  var CSS_Transform = PS["CSS.Transform"];
  var CSSAnimation = PS["CSSAnimation"];
  ...
  var Data_Tuple = PS["Data.Tuple"];
  var Prelude = PS["Prelude"];                 
  var vertical = CSS_Stylesheet.keyframes(AnimationNames.vertical)(new Data_NonEmpty.NonEmpty(new Data_Tuple.Tuple(0.0, CSS_Transform.transform(CSS_Transform.translate(CSS_Size.nil)(CSS_Size.nil))), [ Data_Tuple.Tuple.create(100.0)(CSS_Transform.transform(CSSUtils.translate_(CSS_Size.nil)(CSSConfig.springMotion))) ]));
  ...
  var hintTwinkle = CSS_Animation.animation(CSS_String.fromString(CSS_Animation.isStringAnimationName)(AnimationNames.twinkle))(CSS_Time.sec(1.0))(CSSAnimation.easeInOut)(CSS_Time.sec(0.0))(CSS_Animation.infinite)(CSS_Animation.alternate)(CSSAnimation.none);
  exports["vertical"] = vertical;
  exports["twinkle"] = twinkle;
  exports["root"] = root;
  exports["springOscillation"] = springOscillation;
  exports["hintTwinkle"] = hintTwinkle;
})(PS["Animations"] = PS["Animations"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var CSS_Border = PS["CSS.Border"];
...
(function(exports) {
  ...
  var heroSpringTop = heroSpring + "Top";
  var heroTitle = hero_("title");
  ...
  var headerNavigationDesktopContact = headerNavigationDesktop + "Contact";
  var headerNavigationMobile = header_("nav-mobile");

  // | Gallery
  var gallery = "gallery";
  var gallery_ = namespace(gallery);
  var galleryItem = gallery_("item");
  ...
  exports["headerButtonOpen"] = headerButtonOpen;
  ...
  exports["headerNavigationDesktopContact"] = headerNavigationDesktopContact;
...
(function(exports) {
  ...
  var headerNavigationDesktop = CSSUtils.class_(ClassNames.headerNavigationDesktop);
...
(function(exports) {
    "use strict";
  var image13 = "img/1-7-574x800.jpg";
  var image12 = "img/1-6-800x567.jpg";
  var image11 = "img/1-5-800x566.jpg";
  var image10 = "img/2-4-800x568.jpg";
  var image09 = "img/1-3-800x587.jpg";
  var image08 = "img/1-2-661x800.jpg";
  var image07 = "img/IMG_2156-800x533.jpg";
  var image06 = "img/1-1-575x800.jpg";
  var image05 = "img/hyoushi-1-558x800.jpg";
  var image04 = "img/mega2-1-568x800.jpg";
  var image03 = "img/EPSON004-527x800.jpg";
  var image02 = "img/MG_0321-1-800x533.jpg";

  // | Images
  var image01 = "img/DSC_0020-1-800x532.jpg";

  // | Fonts
  var googleRoboto = "https://fonts.googleapis.com/css?family=Roboto:100,200,300,400,500,700";
  exports["googleRoboto"] = googleRoboto;
  exports["image01"] = image01;
  exports["image02"] = image02;
  exports["image03"] = image03;
  exports["image04"] = image04;
  exports["image05"] = image05;
  exports["image06"] = image06;
  exports["image07"] = image07;
  exports["image08"] = image08;
  exports["image09"] = image09;
...
(function(exports) {
  ...
  var buttonPart = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.relative))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.block))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.rem(7.0e-2)))(function () {
      ...
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.importUrl(Urls.googleRoboto))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector.star)(CSS_Box.boxSizing(CSS_Box.borderBox)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.body)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("font-family")("'Roboto', 'Helvetica Neue', 'Yu Gothic', YuGothic, '\u30d2\u30e9\u30ae\u30ce\u89d2\u30b4 Pro', 'Hiragino Kaku Gothic Pro', '\u30e1\u30a4\u30ea\u30aa', 'Meiryo', sans-serif"))(function () {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.header)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.rem(4.0)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.margin(CSS_Size.nil)(CSS_Size.nil)(CSS_Size.rem(0.1))(CSS_Size.nil))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.a)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Text.textDecoration(CSS_Text.noneTextDecoration))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Text.letterSpacing(CSS_Size.em(6.0e-2)))(function () {
                                  return CSS_Font.color(Colors.black);
                              });
                          })))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Elements.a)(CSSUtils.after))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.absolute))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.left(CSS_Size.nil))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.bottom(CSS_Size.em(-0.5)))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("content")("''"))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.em(0.12)))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.nil))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Colors.robinsEggBlue))(function () {
                                                          return CSSUtils.transition("all")(CSS_Time.ms(250.0))(CSSAnimation.easeInOut)(CSS_Time.ms(0.0));
                                                      });
                                                  });
                                              });
                                          });
                                  ...
                                  return CSS_Stylesheet.select(CSS_Selector["with"](CSS_Elements.a)(CSS_String.fromString(CSS_Selector.isStringRefinement)(":hover::after")))(CSS_Geometry.width(CSS_Size.pct(100.0)));
                              });
                          });
                      });
                  })))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.headerBar)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.fixed))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(100.0)))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.rem(4.0)))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.flex))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.padding2(CSS_Size.rem(0.2))(CSS_Size.rem(0.4)))(function () {
                                              ...
                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.flexWrap(CSS_Flexbox.nowrap))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.alignItems(CSS_Common.center(CSS_Flexbox.centerAlignItemsValue)))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.justifyContent(CSS_Flexbox.spaceBetween(CSS_Flexbox.spaceBetweenJustifyContentValue)))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Color.rgba(255)(255)(255)(0.4)))(function () {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.headerLogo)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.flex))(function () {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.logo)(CSS_Geometry.height(CSS_Size.rem(1.6))))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.headerButtonContainer)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.flex))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.alignItems(CSS_Common.center(CSS_Flexbox.centerAlignItemsValue)))(function () {
                                      ...
                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.headerButton)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("border")("none"))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("background")("none"))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.rem(2.0)))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.rem(1.5)))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.padding1(CSS_Size.nil))(function () {
                                                          return CSS_Display.zIndex(3);
                                                      });
                                                  });
                                              });
                                          });
                                          ...
                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.headerButtonPart1)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(100.0)))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(buttonPart)(function () {
                                                  return CSSUtils.transition("all")(CSS_Time.ms(250.0))(CSSAnimation.easeInOut)(CSS_Time.ms(0.0));
                                              });
                                          })))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.headerButtonPart2)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(75.0)))(function () {
                                                  ...
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](Selectors.headerButton)(CSS_Pseudo.hover))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.headerButtonPart1)(CSS_Geometry.width(CSS_Size.pct(75.0))))(function () {
                                                      ...
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](Selectors.headerButton)(CSSUtils.byClass(ClassNames.headerButtonOpen)))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.headerButtonPart1)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(100.0)))(function () {
                                                          return CSS_Transform.transform(CSS_Transform.rotate(CSS_Size.deg(45.0)));
                                                      })))(function () {
                                                          return CSS_Stylesheet.select(Selectors.headerButtonPart2)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.marginTop(CSS_Size.rem(-0.1)))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(100.0)))(function () {
                                                                  return CSS_Transform.transform(CSS_Transform.rotate(CSS_Size.deg(-45.0)));
                                                              });
                                                          }));
                                                      })))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.headerNavigationDesktop)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.displayNone))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.ul)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.margin1(CSS_Size.nil))(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.padding1(CSS_Size.nil))(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("list-style")("none"))(function () {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.flex))(function () {
                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.flexDirection(CSS_Flexbox.row))(function () {
                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.alignItems(CSS_Common.center(CSS_Flexbox.centerAlignItemsValue)))(function () {
                                                                  ...
                                                                  return CSS_Stylesheet.select(CSS_Elements.li)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.margin2(CSS_Size.nil)(CSS_Size.em(1.0)))(function () {
                                                                      return CSS_Display.position(CSS_Display.relative);
                                                                  }));
                                                              });
                                                          })))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.headerNavigationDesktopContact)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.displayNone))(function () {
                                                                  return CSS_Display.position(CSS_Display.relative);
                                                              })))(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSConfig.half(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.headerNavigationDesktop)(CSS_Display.display(CSS_Display.block)))(function () {
                                                                      return CSS_Stylesheet.select(Selectors.headerNavigationDesktopContact)(CSS_Display.display(CSS_Display.block));
                                                                  })))(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.headerNavigationMobile)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.fixed))(function () {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.flex))(function () {
                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.top(CSS_Size.nil))(function () {
                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.left(CSS_Size.nil))(function () {
                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.vw(100.0)))(function () {
                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.nil))(function () {
                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("opacity")("0.0"))(function () {
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(Colors.white))(function () {
                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Colors.robinsEggBlue))(function () {
                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontSize(CSS_Size.rem(2.0)))(function () {
                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("font-weight")("100"))(function () {
                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.transition("all")(CSS_Time.ms(250.0))(CSSAnimation.easeInOut)(CSS_Time.ms(0.0)))(function () {
                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.ul)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.padding1(CSS_Size.nil))(function () {
                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("list-style")("none"))(function () {
                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.flex))(function () {
                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.flexDirection(CSS_Flexbox.column))(function () {
                                                                                                                                      return CSS_Flexbox.alignItems(CSS_Common.center(CSS_Flexbox.centerAlignItemsValue));
                                                                                                                                  });
                                                                                                                              });
                                                                                                                          });
                                                                                                                      })))(function () {
                                                                                                                          return CSS_Stylesheet.select(CSS_Elements.li)(CSSUtils.margin1(CSS_Size.em(0.5)));
                                                                                                                      });
                                                                                                                  });
                                                                                                              });
                                                                                                          });
                                                                          ...
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](Selectors.headerNavigationMobile)(CSSUtils.byClass(ClassNames.headerButtonOpen)))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.flex))(function () {
                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.alignItems(CSS_Common.center(CSS_Flexbox.centerAlignItemsValue)))(function () {
                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.justifyContent(CSS_Common.center(CSS_Flexbox.centerJustifyContentValue)))(function () {
                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.fixed))(function () {
                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.zIndex(2))(function () {
                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.vh(100.0)))(function () {
                                                                                                  return CSSUtils.pair("opacity")("1.0");
                                                                                              });
                                                                                          });
                                                                                      });
                                                                                  });
                                                                              ...
                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSConfig.half(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](Selectors.headerNavigationMobile)(CSSUtils.byClass(ClassNames.headerButtonOpen)))(CSS_Display.display(CSS_Display.displayNone)))(function () {
                                                                                  return CSS_Stylesheet.select(Selectors.headerButtonContainer)(CSS_Display.display(CSS_Display.displayNone));
                                                                              })))(function () {
                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.hero)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.block))(function () {
                                                                                                  ...
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.heroSpring)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.relative))(function () {
                                                                                                      ...
                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.heroSpringTop)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.em(CSSConfig.ballRadius * 2.0)))(function () {
                                                                                                          ...
                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.heroSpringBottom)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Colors.white))(function () {
                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSConfig.springWidth)(function () {
                                                                                                                  return CSSConfig.springHeight;
                                                                                                              });
                                                                                                          })))(function () {
                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.gallery)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.grid))(function () {
                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("grid-template-columns")("1fr"))(function () {
                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.alignItems(CSS_Common.center(CSS_Flexbox.centerAlignItemsValue)))(function () {
                                                                                                                          return CSS_Stylesheet.select(CSS_Elements.figure)(CSSUtils.padding1(CSS_Size.nil));
                                                                                                                      });
                                                                                                                  });
                                                                                                              })))(function () {
...
(function(exports) {
  ...
  var svg = function (className) {
      return function (code) {
          return function (props) {
              return Svg_Renderer_Halogen.icon(code)(Data_Array.cons(Halogen_HTML_Properties.attr("class")(className))(props));
          };
      };
  };
...
(function(exports) {
  ...
  var logo = HalogenUtils.svg(ClassNames.logo)("\x0a\x09<svg alt=\"aa\" width=\"190\" height=\"48\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 75.11 19.809\">\x0a\x09\x09<defs>\x0a\x09\x09\x09<style>\x0a\x09\x09\x09\x09.cls-1 {\x0a\x09\x09\x09\x09\x09fill: #4ac6b6;\x0a\x09\x09\x09\x09}\x0a\x09\x09\x09\x09.cls-2 {\x0a\x09\x09\x09\x09\x09fill: none;\x0a\x09\x09\x09\x09}\x0a\x09\x09\x09\x09.cls-3 {\x0a\x09\x09\x09\x09\x09fill: #1a1a1a;\x0a\x09\x09\x09\x09}\x0a\x09\x09\x09</style>\x0a\x09\x09</defs>\x0a\x09\x09<g id=\"\u30b7\u30f3\u30dc\u30eb_26_1\" data-name=\"\u30b7\u30f3\u30dc\u30eb 26 \u2013 1\" transform=\"translate(-45 -33)\">\x0a\x09\x09\x09<path id=\"\u30d1\u30b9_3\" data-name=\"\u30d1\u30b9 3\" class=\"cls-1\" d=\"M2.783,19.809H0V0H2.783Z\" transform=\"translate(45 33)\"/>\x0a\x09\x09\x09<path id=\"\u30d1\u30b9_4\" data-name=\"\u30d1\u30b9 4\" class=\"cls-2\" d=\"M91.033,29.569h6.074L93.51,20.3,90.1,29.092l1.052.175Z\" transform=\"translate(-29.813 15.927)\"/>\x0a\x09\x09\x09<path id=\"\u30d1\u30b9_5\" data-name=\"\u30d1\u30b9 5\" class=\"cls-2\" d=\"M82.938,92l-.238.6Z\" transform=\"translate(-23.669 -44.374)\"/>\x0a\x09\x09\x09<path id=\"\u30d1\u30b9_6\" data-name=\"\u30d1\u30b9 6\" class=\"cls-3\" d=\"M65.919,0H63.476L55.4,19.809h2.884l1.748-4.579h0l.238-.6h0l1.018-2.607h0L64.7,3.227l3.6,9.269H63.476l-.865,2.13h6.515l2.019,5.183h2.867Z\" transform=\"translate(5.389 33)\"/>\x0a\x09\x09\x09<path id=\"\u30d1\u30b9_9\" data-name=\"\u30d1\u30b9 9\" class=\"cls-3\" d=\"M65.919,0H63.476L55.4,19.809h2.884l1.748-4.579h0l.238-.6h0l1.018-2.607h0L64.7,3.227l3.6,9.269H63.476l-.865,2.13h6.515l2.019,5.183h2.867Z\" transform=\"translate(33.692 33)\"/>\x0a\x09\x09\x09<path id=\"\u30d1\u30b9_8\" data-name=\"\u30d1\u30b9 8\" class=\"cls-1\" d=\"M82.7,95.8Z\" transform=\"translate(-23.669 -47.57)\"/>\x0a\x09\x09\x09<path id=\"\u30d1\u30b9_10\" data-name=\"\u30d1\u30b9 10\" class=\"cls-3\" d=\"M2.177,0A2.177,2.177,0,1,1,0,2.177,2.177,2.177,0,0,1,2.177,0Z\" transform=\"translate(115.756 48.24)\"/>\x0a\x09\x09</g>\x0a\x09</svg>\x0a       ");
  exports["logo"] = logo;
})(PS["Svgs"] = PS["Svgs"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  ...
  var ButtonOnClick = (function () {
      function ButtonOnClick(value0) {
          this.value0 = value0;
      };
      ButtonOnClick.create = function (value0) {
          return new ButtonOnClick(value0);
      };
  ...
  var render = function (v) {
      ...
      var header = (function () {
          var mobileNav = Halogen_HTML_Elements.nav([ HalogenUtils.classList_([ new Data_Tuple.Tuple(true, ClassNames.headerNavigationMobile), new Data_Tuple.Tuple(v.buttonOpen, ClassNames.headerButtonOpen) ]) ])([ Halogen_HTML_Elements.ul([  ])([ Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("Home") ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("Works") ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("About") ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("Contact") ]) ]) ]);
          return Halogen_HTML_Elements.header([ HalogenUtils.classList([ ClassNames.header ]) ])([ Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.headerBar ]) ])([ Halogen_HTML_Elements.h1([ HalogenUtils.classList([ ClassNames.headerLogo ]) ])([ Svgs.logo([  ]) ]), Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.headerButtonContainer ]) ])([ Halogen_HTML_Elements.button([ HalogenUtils.classList_([ new Data_Tuple.Tuple(true, ClassNames.headerButton), new Data_Tuple.Tuple(v.buttonOpen, ClassNames.headerButtonOpen) ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ButtonOnClick.create)) ])([ Halogen_HTML_Elements.span([ HalogenUtils.classList([ ClassNames.headerButtonPart1 ]) ])([  ]), Halogen_HTML_Elements.span([ HalogenUtils.classList([ ClassNames.headerButtonPart2 ]) ])([  ]) ]) ]), Halogen_HTML_Elements.nav([ HalogenUtils.classList([ ClassNames.headerNavigationDesktop ]) ])([ Halogen_HTML_Elements.ul([  ])([ Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("") ])([ Halogen_HTML_Core.text("Home") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("") ])([ Halogen_HTML_Core.text("Works") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("") ])([ Halogen_HTML_Core.text("About") ]) ]) ]) ]), Halogen_HTML_Elements.span([ HalogenUtils.classList([ ClassNames.headerNavigationDesktopContact ]) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("") ])([ Halogen_HTML_Core.text("Contact") ]) ]), mobileNav ]) ]);
      })();
      var gallery = (function () {
          ...
          return Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.gallery ]) ])([ galleryItem(Urls.image01), galleryItem(Urls.image02), galleryItem(Urls.image03), galleryItem(Urls.image04), galleryItem(Urls.image05), galleryItem(Urls.image06), galleryItem(Urls.image07), galleryItem(Urls.image08), galleryItem(Urls.image09), galleryItem(Urls.image10), galleryItem(Urls.image11), galleryItem(Urls.image12), galleryItem(Urls.image13) ]);
      })();
      var footer = Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.footer ]) ])([ Halogen_HTML_Elements.small_([ Halogen_HTML_Core.text("\xa9 Institute of Architectural Anthropology") ]) ]);
      return Halogen_HTML_Elements.div_([ header, hero, gallery, navigator, footer, Halogen_HTML_CSS.stylesheet(CSSRoot.root) ]);
  };
  var initialState = {
      buttonOpen: false
  };
