...
root = do
  ...
  CSS.select (class_ "elem-yellow") Styles.elem_yellow
  do
    CSS.select (class_ "elem-yellow" |> class_ "label") Styles.allLabel_yellow
    CSS.select (class_ "elem-yellow" |> class_ "endLabel") Styles.allLabel_yellow
  CSS.select (class_ "elem-green") Styles.elem_green
  do
    CSS.select (class_ "elem-green" |> class_ "label") Styles.allLabel_green
    CSS.select (class_ "elem-green" |> class_ "endLabel") Styles.allLabel_green
  ...
  CSS.select (CSS.nav & byClass "elem") Styles.nav_elem
  CSS.select (class_ "elem" |* CSS.p) Styles.elem_p
  CSS.select (class_ "ipsum") Styles.ipsum
  CSS.select CSS.footer Styles.footer_
  CSS.select (CSS.footer & byClass "elem") Styles.footer_elem
