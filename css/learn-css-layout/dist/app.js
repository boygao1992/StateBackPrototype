...
(function(exports) {
  ...
  var valClearFloat = new CSS_Property.Val(function (v) {
      ...
      throw new Error("Failed pattern match at CSS.Display line 151, column 1 - line 151, column 43: " + [ v.constructor.name ]);
  });                                                                             
  ...
  exports["floatRight"] = floatRight;
  exports["float"] = $$float;
  exports["ClearFloatLeft"] = ClearFloatLeft;
  exports["ClearFloatRight"] = ClearFloatRight;
  exports["ClearFloatBoth"] = ClearFloatBoth;
  exports["ClearFloatNone"] = ClearFloatNone;
  exports["ClearFloatInherit"] = ClearFloatInherit;
  exports["ClearFloatInlineStart"] = ClearFloatInlineStart;
  exports["ClearFloatInlineEnd"] = ClearFloatInlineEnd;
  exports["clearLeft"] = clearLeft;
  exports["clear"] = clear;
  exports["zIndex"] = zIndex;
  exports["valPosition"] = valPosition;
  exports["valFloat"] = valFloat;
  exports["valClearFloat"] = valClearFloat;
...
(function(exports) {
  ...
  var Data_Maybe = PS["Data.Maybe"];
  var Prelude = PS["Prelude"];
  var pseudo = function ($1) {
      return CSS_Selector.Refinement(Control_Applicative.pure(Control_Applicative.applicativeArray)(CSS_Selector.Pseudo.create($1)));
  };
  ...
  // | Selector
  var byId = function ($2) {
      return CSS_Selector.Refinement(Control_Applicative.pure(Control_Applicative.applicativeArray)(CSS_Selector.Id.create($2)));
  };
  var id_ = function (s) {
      return CSS_Selector["with"](CSS_Selector.star)(byId(s));
  };
  var byClass = function ($3) {
      return CSS_Selector.Refinement(Control_Applicative.pure(Control_Applicative.applicativeArray)(CSS_Selector.Class.create($3)));
  };
  var class_ = function (s) {
      return CSS_Selector["with"](CSS_Selector.star)(byClass(s));
  };
  var borderWidth = CSS_Stylesheet.key(CSS_Size.valSize)(CSS_String.fromString(CSS_Property.isStringKey)("border-width"));
  exports["byId"] = byId;
...
(function(exports) {
  ...
  var elemYellow = "elem-yellow";
  var elemRed = "elem-red";
  var elemGreen = "elem-green";
  var elem = "elem";
  exports["elem"] = elem;
  exports["elemRed"] = elemRed;
  exports["elemGreen"] = elemGreen;
  exports["elemYellow"] = elemYellow;
  exports["label"] = label;
  exports["endLabel"] = endLabel;
...
(function(exports) {
  ...
  var whitesmoke = safeFromHexString("#eee");
  var yellow = safeFromHexString("#FDC72F");
  var red = safeFromHexString("#D64078");
  var lightGreen = safeFromHexString("#96C02E");
  var green = safeFromHexString("#6AC5AC");

  // | Color
  var gray = safeFromHexString("#ECECEC");
  var darkRed = safeFromHexString("#734161");
  var dark = safeFromHexString("#414142");
...
(function(exports) {
  ...
  var Data_Ring = PS["Data.Ring"];
  var Prelude = PS["Prelude"];                 
  var static_ = CSS_Display.position(CSS_Display["static"]);
  var star_ = CSS_Box.boxSizing(CSS_Box.borderBox);
  var simple = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.px(500.0)))(function () {
      return CSSUtils.margin2(CSS_Size.px(20.0))(CSS_Common.auto(CSS_Size.autoSize));
  });
  var simple2 = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(simple)(function () {
      return CSS_Box.boxSizing(CSS_Box.borderBox);
  });
  var section_ = CSS_Geometry.marginLeft(CSS_Size.px(200.0));
  var relative_ = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.relative))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.px(600.0)))(function () {
          return CSS_Geometry.height(CSS_Size.px(400.0));
      });
  });
  var relative1 = CSS_Display.position(CSS_Display.relative);
  var relative2 = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(relative1)(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.top(CSS_Size.px(-20.0)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.left(CSS_Size.px(20.0)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Colors.white))(function () {
                  return CSS_Geometry.width(CSS_Size.px(500.0));
              });
          });
      });
  });                                                       
  var nav_elem = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.absolute))(function () {
  ...
  var nav_ = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display["float"](CSS_Display.floatLeft))(function () {
      return CSS_Geometry.width(CSS_Size.px(200.0));
  });
  var main2 = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.maxWidth(CSS_Size.px(600.0)))(function () {
      return CSSUtils.margin2(CSS_Size.nil)(CSS_Common.auto(CSS_Size.autoSize));
  });
  var main = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.px(600.0)))(function () {
      return CSSUtils.margin2(CSS_Size.nil)(CSS_Common.auto(CSS_Size.autoSize));
  });
  var link_normal = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(Colors.red))(function () {
      return CSS_Text.textDecoration(CSS_Text.noneTextDecoration);
  });
  var link_hover = CSS_Text.textDecoration(CSS_Text.underline);
  var label = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.top(CSS_Size.nil))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.left(CSS_Size.nil))(function () {
          return CSS_Geometry.padding(CSS_Size.nil)(CSS_Size.px(3.0))(CSS_Size.px(3.0))(CSS_Size.nil);
      });
  });
  var ipsum = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(Colors.darkRed))(function () {
      return CSS_Background.backgroundColor(Colors.whitesmoke);
  });
  var img_ = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display["float"](CSS_Display.floatRight))(function () {
      return CSS_Geometry.margin(CSS_Size.nil)(CSS_Size.nil)(CSS_Size.em(1.0))(CSS_Size.em(1.0));
  });
  var footer_elem = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.fixed))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.bottom(CSS_Size.nil))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.left(CSS_Size.nil))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.px(75.0)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Colors.white))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(100.0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.margin1(CSS_Size.nil))(function () {
  ...
  var footer_ = CSS_TextAlign.textAlign(CSS_TextAlign.center);
  var fixed_ = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.fixed))(function () {
  ...
  var fancy = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(simple)(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.padding1(CSS_Size.px(50.0)))(function () {
          return CSSUtils.borderWidth(CSS_Size.px(10.0));
      });
  });
  var fancy2 = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(fancy)(function () {
      return CSS_Box.boxSizing(CSS_Box.borderBox);
  });
  var endLabel = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.right(CSS_Size.nil))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.bottom(CSS_Size.nil))(function () {
          return CSS_Geometry.padding(CSS_Size.px(3.0))(CSS_Size.nil)(CSS_Size.nil)(CSS_Size.px(3.0));
      });
  });
  var elem_yellow = CSS_Border.border(CSS_Border.solid)(CSS_Size.px(3.0))(Colors.yellow);
  var elem_red = CSS_Border.border(CSS_Border.solid)(CSS_Size.px(3.0))(Colors.red);
  var elem_p = CSSUtils.padding2(CSS_Size.nil)(CSS_Size.em(1.0));
  var elem_green = CSS_Border.border(CSS_Border.solid)(CSS_Size.px(3.0))(Colors.lightGreen);
  var elem = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Border.border(CSS_Border.solid)(CSS_Size.px(3.0))(Colors.green))(function () {
      return CSS_Display.position(CSS_Display.relative);
  });
  var code = CSS_Background.backgroundColor(Colors.gray);
  var clearfix = CSS_Overflow.overflow(CSS_Overflow.overflowAuto);
  var box = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display["float"](CSS_Display.floatLeft))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.px(200.0)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.px(100.0)))(function () {
              return CSSUtils.margin1(CSS_Size.em(1.0));
          });
      });
  });
  var article_img = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display["float"](CSS_Display.floatRight))(function () {
      return CSS_Geometry.width(CSS_Size.pct(50.0));
  });
  var allLabel_yellow = CSS_Background.backgroundColor(Colors.yellow);
  var allLabel_red = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(Colors.white))(function () {
      return CSS_Background.backgroundColor(Colors.red);
  });
  var allLabel_green = CSS_Background.backgroundColor(Colors.lightGreen);
  var allLabel = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.absolute))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Colors.green))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(Colors.dark))(function () {
              return CSS_Geometry.lineHeight(CSS_Size.em(1.0));
          });
      });
  });
  var after_box = CSS_Display.clear(CSS_Display.clearLeft);
  var absolute_ = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.absolute))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.top(CSS_Size.px(120.0)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.right(CSS_Size.nil))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.px(300.0)))(function () {
  ...
  exports["star_"] = star_;
  exports["elem_p"] = elem_p;
  exports["main"] = main;
  exports["main2"] = main2;
  exports["elem"] = elem;
  exports["elem_red"] = elem_red;
  exports["elem_yellow"] = elem_yellow;
  exports["elem_green"] = elem_green;
  exports["code"] = code;
  exports["link_normal"] = link_normal;
  exports["link_hover"] = link_hover;
  exports["label"] = label;
  exports["endLabel"] = endLabel;
  exports["allLabel"] = allLabel;
  exports["allLabel_red"] = allLabel_red;
  exports["allLabel_yellow"] = allLabel_yellow;
  exports["allLabel_green"] = allLabel_green;
  exports["simple"] = simple;
  exports["fancy"] = fancy;
  exports["simple2"] = simple2;
  exports["fancy2"] = fancy2;
  exports["static_"] = static_;
  exports["relative1"] = relative1;
  exports["relative2"] = relative2;
  exports["fixed_"] = fixed_;
  exports["relative_"] = relative_;
  exports["absolute_"] = absolute_;
  exports["section_"] = section_;
  exports["nav_elem"] = nav_elem;
  exports["ipsum"] = ipsum;
  exports["footer_"] = footer_;
  exports["footer_elem"] = footer_elem;
  exports["img_"] = img_;
  exports["box"] = box;
  exports["after_box"] = after_box;
  exports["nav_"] = nav_;
  exports["clearfix"] = clearfix;
  exports["article_img"] = article_img;
})(PS["Styles"] = PS["Styles"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  ...
  var root = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector.star)(Styles.star_))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.code)(Styles.code))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.id_("main"))(Styles.main))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.id_("main2"))(Styles.main2))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.id_("simple"))(Styles.simple))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.id_("simple2"))(Styles.simple2))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.id_("fancy"))(Styles.fancy))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.id_("fancy2"))(Styles.fancy2))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.class_(ClassNames.elem))(Styles.elem))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.class_(ClassNames.elemRed))(Styles.elem_red))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector.child(CSSUtils.class_(ClassNames.elemRed))(CSSUtils.class_(ClassNames.label)))(Styles.allLabel_red))(function () {
                                              return CSS_Stylesheet.select(CSS_Selector.child(CSSUtils.class_(ClassNames.elemRed))(CSSUtils.class_(ClassNames.endLabel)))(Styles.allLabel_red);
                                          }))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.class_(ClassNames.elemYellow))(Styles.elem_yellow))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector.child(CSSUtils.class_(ClassNames.elemYellow))(CSSUtils.class_(ClassNames.label)))(Styles.allLabel_yellow))(function () {
                                                      return CSS_Stylesheet.select(CSS_Selector.child(CSSUtils.class_(ClassNames.elemYellow))(CSSUtils.class_(ClassNames.endLabel)))(Styles.allLabel_yellow);
                                                  }))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.class_(ClassNames.elemGreen))(Styles.elem_green))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector.child(CSSUtils.class_(ClassNames.elemGreen))(CSSUtils.class_(ClassNames.label)))(Styles.allLabel_green))(function () {
                                                              return CSS_Stylesheet.select(CSS_Selector.child(CSSUtils.class_(ClassNames.elemGreen))(CSSUtils.class_(ClassNames.endLabel)))(Styles.allLabel_green);
                                                          }))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.class_(ClassNames.label))(Styles.label))(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.class_(ClassNames.endLabel))(Styles.endLabel))(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.class_(ClassNames.label))(Styles.allLabel))(function () {
                                                                          return CSS_Stylesheet.select(CSSUtils.class_(ClassNames.endLabel))(Styles.allLabel);
                                                                      }))(function () {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Elements.a)(CSSUtils.pseudo("link")))(Styles.link_normal))(function () {
                                                                              return CSS_Stylesheet.select(CSS_Selector["with"](CSS_Elements.a)(CSS_Pseudo.hover))(Styles.link_hover);
                                                                          }))(function () {
                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.class_("static"))(Styles.static_))(function () {
                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.class_("relative1"))(Styles.relative1))(function () {
                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.class_("relative2"))(Styles.relative2))(function () {
                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.class_("fixed"))(Styles.fixed_))(function () {
                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.class_("relative"))(Styles.relative_))(function () {
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.class_("absolute"))(Styles.absolute_))(function () {
                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.class_(ClassNames.section))(Styles.section_))(function () {
                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Elements.nav)(CSSUtils.byClass(ClassNames.elem)))(Styles.nav_elem))(function () {
                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector.deep(CSSUtils.class_(ClassNames.elem))(CSS_Elements.p))(Styles.elem_p))(function () {
                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.class_("ipsum"))(Styles.ipsum))(function () {
                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.footer)(Styles.footer_))(function () {
                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Elements.footer)(CSSUtils.byClass(ClassNames.elem)))(Styles.footer_elem))(function () {
                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.img)(Styles.img_))(function () {
                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.class_("box"))(Styles.box))(function () {
                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.class_("after-box"))(Styles.after_box))(function () {
                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.class_("nav"))(Styles.nav_))(function () {
                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.class_("clearfix"))(Styles.clearfix))(function () {
                                                                                                                                                  return CSS_Stylesheet.select(CSS_Selector.deep(CSS_Elements.article)(CSS_Elements.img))(Styles.article_img);
                                                                                                                                              });
                                                                                                                                          });
                                                                                                                                      });
                                                                                                                                  });
...
(function(exports) {
  ...
  var classList = function ($4) {
      return Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)($4));
  };
  var clear_ = (function () {
      var withoutClear = Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ classList([ "box", ClassNames.elem ]) ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<div class=\"box\">") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("I feel like I'm floating!") ]), Halogen_HTML_Elements.span([ classList([ ClassNames.endLabel ]) ])([ Halogen_HTML_Core.text("</div>") ]) ]), Halogen_HTML_Elements.section([ classList([ ClassNames.elem, ClassNames.elemYellow ]) ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<section>") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("In this case, the "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("section") ]), Halogen_HTML_Core.text(" element is actually after the "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("div") ]), Halogen_HTML_Core.text(". However, since the "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("div") ]), Halogen_HTML_Core.text(" is floated to the left, this is what happens: the text in the section is floated around the "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("div") ]), Halogen_HTML_Core.text(" and the "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("section") ]), Halogen_HTML_Core.text(" surrounds the whole thing. What if we wanted the section to actually appear after the floated element?") ]), Halogen_HTML_Elements.span([ classList([ ClassNames.endLabel ]) ])([ Halogen_HTML_Core.text("</section>") ]) ]) ]);
      var withClear = Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ classList([ "box", ClassNames.elem ]) ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<div class=\"box\">") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("I feel like I'm floating!") ]), Halogen_HTML_Elements.span([ classList([ ClassNames.endLabel ]) ])([ Halogen_HTML_Core.text("</div>") ]) ]), Halogen_HTML_Elements.section([ classList([ ClassNames.elem, ClassNames.elemYellow, "after-box" ]) ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<section class=\"after-box\">") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Using "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("clear") ]), Halogen_HTML_Core.text(" we have now moved this section down below the floated "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("div") ]), Halogen_HTML_Core.text(". You use the value "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("left") ]), Halogen_HTML_Core.text(" to clear elements floated to the left. You can also clear "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("right") ]), Halogen_HTML_Core.text(" and "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("both") ]), Halogen_HTML_Core.text(".") ]), Halogen_HTML_Elements.span([ classList([ ClassNames.endLabel ]) ])([ Halogen_HTML_Core.text("</section>") ]) ]) ]);
      return Halogen_HTML_Elements.div_([ withoutClear, withClear ]);
  })();
  var clearfix = (function () {
      var withoutClearfix = Halogen_HTML_Elements.div([ classList([ ClassNames.elem ]) ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<div>") ]), Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("./images/ilta.png") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Uh oh... this image is taller than the element containing it, and it's floated, so it's overflowing outside of its container!") ]) ]);
      var withClearfix = Halogen_HTML_Elements.div([ classList([ ClassNames.elem, "clearfix" ]) ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<div class=\"clearfix\">") ]), Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("./images/ilta.png") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Much better!") ]), Halogen_HTML_Elements.span([ classList([ ClassNames.endLabel ]) ])([ Halogen_HTML_Core.text("</div>") ]) ]);
      return Halogen_HTML_Elements.div_([ withoutClearfix, withClearfix ]);
  })();                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
  var floatLayoutExample = (function () {
      var floatLayoutExampleSection2 = Halogen_HTML_Elements.section([ classList([ ClassNames.elem, ClassNames.elemYellow, ClassNames.section, "ipsum" ]) ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<section>") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum interdum, nisi lorem egestas odio, vitae scelerisque enim ligula venenatis dolor. Maecenas nisl est, ultrices nec congue eget, auctor vitae massa. Fusce luctus vestibulum augue ut aliquet. Mauris ante ligula, facilisis sed ornare eu, lobortis in odio. Praesent convallis urna a lacus interdum ut hendrerit risus congue. Nunc sagittis dictum nisi, sed ullamcorper ipsum dignissim ac. In at libero sed nunc venenatis imperdiet sed ornare turpis. Donec vitae dui eget tellus gravida venenatis. Integer fringilla congue eros non fermentum. Sed dapibus pulvinar nibh tempor porta. Cras ac leo purus. Mauris quis diam velit.") ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_(ClassNames.endLabel) ])([ Halogen_HTML_Core.text("</section>") ]) ]);
      var floatLayoutExampleSection1 = Halogen_HTML_Elements.section([ classList([ ClassNames.elem, ClassNames.elemYellow, ClassNames.section ]) ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<section>") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("The "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("margin-left") ]), Halogen_HTML_Core.text(" style for "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("section") ]), Halogen_HTML_Core.text("s makes sure there is room for the "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("nav") ]), Halogen_HTML_Core.text(". Otherwise, the absolute and static elements would overlap") ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_(ClassNames.endLabel) ])([ Halogen_HTML_Core.text("</section>") ]) ]);
      var floatLayoutExampleNav = Halogen_HTML_Elements.nav([ classList([ ClassNames.elem, ClassNames.elemRed, "nav" ]) ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<nav>") ]), Halogen_HTML_Elements.ul_([ Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(".") ])([ Halogen_HTML_Core.text("Home") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(".") ])([ Halogen_HTML_Core.text("Taco Menu") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(".") ])([ Halogen_HTML_Core.text("Draft List") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(".") ])([ Halogen_HTML_Core.text("Hours") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(".") ])([ Halogen_HTML_Core.text("Directions") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(".") ])([ Halogen_HTML_Core.text("Contact") ]) ]) ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_(ClassNames.endLabel) ])([ Halogen_HTML_Core.text("</nav>") ]) ]);
      return Halogen_HTML_Elements.div([ classList([ ClassNames.elem, "container" ]) ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<div class=\"container\">") ]), floatLayoutExampleNav, floatLayoutExampleSection1, floatLayoutExampleSection2 ]);
  })();
  var float_ = Halogen_HTML_Elements.p([ classList([ "content", "ipsum" ]) ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("./images/ilta.png") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum interdum, nisi lorem egestas odio, vitae scelerisque enim ligula venenatis dolor. Maecenas nisl est, ultrices nec congue eget, auctor vitae massa. Fusce luctus vestibulum augue ut aliquet. Mauris ante ligula, facilisis sed ornare eu, lobortis in odio. Praesent convallis urna a lacus interdum ut hendrerit risus congue. Nunc sagittis dictum nisi, sed ullamcorper ipsum dignissim ac. In at libero sed nunc venenatis imperdiet sed ornare turpis. Donec vitae dui eget tellus gravida venenatis. Integer fringilla congue eros non fermentum. Sed dapibus pulvinar nibh tempor porta. Cras ac leo purus. Mauris quis diam velit.") ]) ]);
  var marginAuto = Halogen_HTML_Elements.div([ classList([ ClassNames.elem ]), Halogen_HTML_Properties.id_("main") ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<div id=\"main\">") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Setting the "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("width") ]), Halogen_HTML_Core.text(" of a block-level element will prevent it from stretching out to the edges of its container to the left and right. Then, you can set the left and right margins to "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("auto") ]), Halogen_HTML_Core.text(" to horizontally center that element within its container. The element will take up the width you specify, then the remaining space will be split evenly between the two margins.") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("The only problem occurs when the browser window is narrower than the width of your element. The browser resolves this by creating a horizontal scrollbar on the page. Let's improve the situation...") ]), Halogen_HTML_Elements.span([ classList([ ClassNames.endLabel ]) ])([ Halogen_HTML_Core.text("</div>") ]) ]);
  var maxWidth = Halogen_HTML_Elements.div([ classList([ ClassNames.elem ]), Halogen_HTML_Properties.id_("main2") ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<div id=\"main2\">") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Using "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("max-width") ]), Halogen_HTML_Core.text(" instead of "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("width") ]), Halogen_HTML_Core.text(" in this situation will improve the browser's handling of small windows. This is important when making a site usable on mobile. Resize this page to check it out!") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("By the way, "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("max-width") ]), Halogen_HTML_Core.text(" is "), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("http://caniuse.com/#search=max-width") ])([ Halogen_HTML_Core.text("supported by all major browsers") ]), Halogen_HTML_Core.text(" including IE7+ so you shouldn't be afraid of using it.") ]), Halogen_HTML_Elements.span([ classList([ ClassNames.endLabel ]) ])([ Halogen_HTML_Core.text("</div>") ]) ]);
  var percentWidth = Halogen_HTML_Elements.article([ classList([ ClassNames.elem, ClassNames.elemYellow, "clearfix" ]) ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<article class=\"clearfix\">") ]), Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("./images/ilta.png") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("You could even use "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("min-width") ]), Halogen_HTML_Core.text(" and "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("max-width") ]), Halogen_HTML_Core.text(" to limit how big or small the image can get!") ]), Halogen_HTML_Elements.span([ classList([ ClassNames.endLabel ]) ])([ Halogen_HTML_Core.text("</article>") ]) ]);
  var position = (function () {
      var positionStatic = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(ClassNames.elem) ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<div id=\"static\">") ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.class_("static") ])([ Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("static") ]), Halogen_HTML_Core.text(" is the default value. An element with "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("position: static") ]), Halogen_HTML_Core.text("; is not positioned in any special way. A static element is said to be not positioned and an element with its position set to anything else is said to be "), Halogen_HTML_Elements.i_([ Halogen_HTML_Core.text("positioned") ]), Halogen_HTML_Core.text(".") ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_(ClassNames.endLabel) ])([ Halogen_HTML_Core.text("</div>") ]) ]);
      var positionRelative = Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ classList([ ClassNames.elem, "relative1" ]) ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<div id=\"relative1\">") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("relative") ]), Halogen_HTML_Core.text(" behaves the same as "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("static") ]), Halogen_HTML_Core.text(" unless you add some extra properties.") ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_(ClassNames.endLabel) ])([ Halogen_HTML_Core.text("</div>") ]) ]), Halogen_HTML_Elements.div([ classList([ ClassNames.elemRed, "relative2" ]) ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<div id=\"relative2\">") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Setting the "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("top") ]), Halogen_HTML_Core.text(", "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("right") ]), Halogen_HTML_Core.text(", "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("bottom") ]), Halogen_HTML_Core.text(", and "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("left") ]), Halogen_HTML_Core.text(" properties of a relatively-positioned element will cause it to be adjusted away from its normal position. Other content will not be adjusted to fit into any gap left by the element.") ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_(ClassNames.endLabel) ])([ Halogen_HTML_Core.text("</div>") ]) ]) ]);
      var positionFixed = Halogen_HTML_Elements.div([ classList([ ClassNames.elemYellow, "fixed" ]) ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<div id=\"fixed\">") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Hello! Don't pay attention to me yet.") ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_(ClassNames.endLabel) ])([ Halogen_HTML_Core.text("</div>") ]) ]);
      var positionAbsolute = Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ classList([ ClassNames.elem, "relative" ]) ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<div id=\"relative\">") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("This element is relatively-positioned. If this element was "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("position: static") ]), Halogen_HTML_Core.text("; its absolutely-positioned child would escape and would be positioned relative to the document body. ") ]), Halogen_HTML_Elements.div([ classList([ ClassNames.elemRed, "absolute" ]) ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<div id=\"absolute\">") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("This element is absolutely-positioned. It's positioned relative to its parent.") ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_(ClassNames.endLabel) ])([ Halogen_HTML_Core.text("</div>") ]) ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_(ClassNames.endLabel) ])([ Halogen_HTML_Core.text("</div>") ]) ]) ]);
      return Halogen_HTML_Elements.div_([ positionStatic, positionRelative, positionFixed, positionAbsolute ]);
  })();
  var positionExample = (function () {
      var positionExampleSection3 = Halogen_HTML_Elements.section([ classList([ ClassNames.elem, ClassNames.elemYellow, ClassNames.section ]) ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<section>") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Notice what happens when you resize your browser. It works nicely!") ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_(ClassNames.endLabel) ])([ Halogen_HTML_Core.text("</section>") ]) ]);
      var positionExampleSection2 = Halogen_HTML_Elements.section([ classList([ ClassNames.elem, ClassNames.elemYellow, ClassNames.section, "ipsum" ]) ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<section>") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum interdum, nisi lorem egestas odio, vitae scelerisque enim ligula venenatis dolor. Maecenas nisl est, ultrices nec congue eget, auctor vitae massa. Fusce luctus vestibulum augue ut aliquet. Mauris ante ligula, facilisis sed ornare eu, lobortis in odio. Praesent convallis urna a lacus interdum ut hendrerit risus congue. Nunc sagittis dictum nisi, sed ullamcorper ipsum dignissim ac. In at libero sed nunc venenatis imperdiet sed ornare turpis. Donec vitae dui eget tellus gravida venenatis. Integer fringilla congue eros non fermentum. Sed dapibus pulvinar nibh tempor porta. Cras ac leo purus. Mauris quis diam velit.") ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_(ClassNames.endLabel) ])([ Halogen_HTML_Core.text("</section>") ]) ]);
      var positionExampleSection1 = Halogen_HTML_Elements.section([ classList([ ClassNames.elem, ClassNames.elemYellow, ClassNames.section ]) ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<section>") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("The "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("margin-left") ]), Halogen_HTML_Core.text(" style for "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("section") ]), Halogen_HTML_Core.text("s makes sure there is room for the "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("nav") ]), Halogen_HTML_Core.text(". Otherwise, the absolute and static elements would overlap") ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_(ClassNames.endLabel) ])([ Halogen_HTML_Core.text("</section>") ]) ]);
      var positionExampleNav = Halogen_HTML_Elements.nav([ classList([ ClassNames.elem, ClassNames.elemRed ]) ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<nav>") ]), Halogen_HTML_Elements.ul_([ Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(".") ])([ Halogen_HTML_Core.text("Home") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(".") ])([ Halogen_HTML_Core.text("Taco Menu") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(".") ])([ Halogen_HTML_Core.text("Draft List") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(".") ])([ Halogen_HTML_Core.text("Hours") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(".") ])([ Halogen_HTML_Core.text("Directions") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(".") ])([ Halogen_HTML_Core.text("Contact") ]) ]) ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_(ClassNames.endLabel) ])([ Halogen_HTML_Core.text("</nav>") ]) ]);
      var positionExampleFooter = Halogen_HTML_Elements.footer([ classList([ ClassNames.elem, ClassNames.elemGreen ]) ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<footer>") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("If you use a fixed header or footer, make sure there is room for it! I put a "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("margin-bottom") ]), Halogen_HTML_Core.text(" on the "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("body") ]), Halogen_HTML_Core.text(".") ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_(ClassNames.endLabel) ])([ Halogen_HTML_Core.text("</footer>") ]) ]);
      return Halogen_HTML_Elements.div([ classList([ ClassNames.elem, "container" ]) ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<div class=\"container\">") ]), positionExampleNav, positionExampleSection1, positionExampleSection2, positionExampleSection3 ]);
  })();
  var theBoxModel = Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ classList([ ClassNames.elem ]), Halogen_HTML_Properties.id_("simple") ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<div id=\"simple\">") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(" I'm smaller...") ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_(ClassNames.endLabel) ])([ Halogen_HTML_Core.text("</div>") ]) ]), Halogen_HTML_Elements.div([ classList([ ClassNames.elem ]), Halogen_HTML_Properties.id_("fancy") ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<div id=\"fancy\">") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("And I'm bigger!") ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_(ClassNames.endLabel) ])([ Halogen_HTML_Core.text("</div>") ]) ]) ]);
  var boxSizing = Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ classList([ ClassNames.elem ]), Halogen_HTML_Properties.id_("simple2") ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<div id=\"simple2\">") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("We're the same size now!") ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_(ClassNames.endLabel) ])([ Halogen_HTML_Core.text("</div>") ]) ]), Halogen_HTML_Elements.div([ classList([ ClassNames.elem ]), Halogen_HTML_Properties.id_("fancy2") ])([ Halogen_HTML_Elements.span([ classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<div id=\"fancy2\">") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Hooray!") ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_(ClassNames.endLabel) ])([ Halogen_HTML_Core.text("</div>") ]) ]) ]);
  var render = function (v) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_CSS.stylesheet(CSSModule.root), marginAuto, maxWidth, theBoxModel, boxSizing, position, positionExample, float_, clear_, clearfix, floatLayoutExample, percentWidth ]);
  };
  ...
  exports["maxWidth"] = maxWidth;
  exports["theBoxModel"] = theBoxModel;
  exports["boxSizing"] = boxSizing;
  exports["position"] = position;
  exports["positionExample"] = positionExample;
  exports["float_"] = float_;
  exports["clear_"] = clear_;
  exports["clearfix"] = clearfix;
  exports["floatLayoutExample"] = floatLayoutExample;
  exports["percentWidth"] = percentWidth;
  exports["render"] = render;
  exports["component"] = component;
