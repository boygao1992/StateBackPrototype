...
(function(exports) {
  ...
  var valListStyleType = new CSS_Property.Val(function (v) {
      ...
      throw new Error("Failed pattern match at CSS.ListStyle.Type line 37, column 1 - line 37, column 47: " + [ v.constructor.name ]);
  });                       
  ...
  exports["CJKIdeographic"] = CJKIdeographic;
  exports["Kannada"] = Kannada;
  exports["None"] = None;
  exports["Inherit"] = Inherit;
  exports["Initial"] = Initial;
  exports["Unset"] = Unset;
  exports["CustomStyleType"] = CustomStyleType;
  exports["StringStyleType"] = StringStyleType;
  exports["listStyleType"] = listStyleType;
  exports["valListStyleType"] = valListStyleType;
...
(function(exports) {
  ...
  var valTextTransform = new CSS_Property.Val(function (v) {
      ...
      throw new Error("Failed pattern match at CSS.Text.Transform line 32, column 1 - line 32, column 47: " + [ v.constructor.name ]);
  });
  ...
  exports["valTextTransform"] = valTextTransform;
})(PS["CSS.Text.Transform"] = PS["CSS.Text.Transform"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var CSS_Property = PS["CSS.Property"];
...
(function(exports) {
  ...
  var pseudo = function ($18) {
      return CSS_Selector.Refinement(Control_Applicative.pure(Control_Applicative.applicativeArray)(CSS_Selector.Pseudo.create($18)));
  };
...
(function(exports) {
  ...
  var springgreen = Color_Scheme_X11.springgreen;
  var mineshaft = CSSUtils.safeFromHexString("#232323");
  var lightgray = Color_Scheme_X11.lightgray;
  exports["white"] = white;
  exports["lightgray"] = lightgray;
  exports["springgreen"] = springgreen;
...
(function(exports) {
    "use strict";
  var unstyledList = "unstyled-list";
  var title = "title";
  var portfolioList = "port-list";
  var portfolioItem = "port-item";
  var portfolioDescriptionBox = "port-desc-box";
  var portfolioDescription = "port-desc";
  var portfolio = "portfolio";
  var logo = "logo";

  // | Local
  var homeHero = "home-hero";
  var homeAboutTextBox = "home-about-text-box";
  var homeAboutText = "home-about-text";
  ...
  var buttonSmall = "button-small";
  var buttonDark = "button-dark";
  var buttonAccent = "button-accent";
  var button = "button";
  ...
  exports["homeAbout"] = homeAbout;
  exports["homeAboutText"] = homeAboutText;
  exports["homeAboutTextBox"] = homeAboutTextBox;
  exports["portfolio"] = portfolio;
  exports["portfolioList"] = portfolioList;
  exports["portfolioItem"] = portfolioItem;
  exports["portfolioDescriptionBox"] = portfolioDescriptionBox;
  exports["portfolioDescription"] = portfolioDescription;
...
(function(exports) {
  ...
  var unstyledList = CSSUtils.class_(ClassNames.unstyledList);
  var title = CSSUtils.class_(ClassNames.title);
  var portfolioList = CSSUtils.class_(ClassNames.portfolioList);
  var portfolioItem = CSSUtils.class_(ClassNames.portfolioItem);
  var portfolioDescriptionBox = CSSUtils.class_(ClassNames.portfolioDescriptionBox);
  var portfolioDescription = CSSUtils.class_(ClassNames.portfolioDescription);
  var portfolio = CSSUtils.class_(ClassNames.portfolio);
  var logo = CSSUtils.class_(ClassNames.logo);
  var homeHero = CSSUtils.class_(ClassNames.homeHero);
  var homeAboutTextBox = CSSUtils.class_(ClassNames.homeAboutTextBox);
  var homeAboutText = CSSUtils.class_(ClassNames.homeAboutText);
  var homeAbout = CSSUtils.class_(ClassNames.homeAbout);
  var footer = CSSUtils.class_(ClassNames.footer);

  // | id selectors
  // | class selectors
  var container = CSSUtils.class_(ClassNames.container);
  var column3 = CSSUtils.class_(ClassNames.column3);
  var column1 = CSSUtils.class_(ClassNames.column1);
  var callToAction = CSSUtils.class_(ClassNames.callToAction);
  var buttonSmall = CSSUtils.class_(ClassNames.buttonSmall);
  var buttonDark = CSSUtils.class_(ClassNames.buttonDark);
  var buttonAccent = CSSUtils.class_(ClassNames.buttonAccent);
  var button = CSSUtils.class_(ClassNames.button);
  var boxTitle = CSSUtils.class_(ClassNames.boxTitle);
  exports["container"] = container;
  exports["logo"] = logo;
  exports["unstyledList"] = unstyledList;
  exports["title"] = title;
...
(function(exports) {
    "use strict";
  var portfolio6 = "img/portfolio-06.jpg";
  var portfolio5 = "img/portfolio-05.jpg";
  var portfolio4 = "img/portfolio-04.jpg";
  var portfolio3 = "img/portfolio-03.jpg";
  var portfolio2 = "img/portfolio-02.jpg";
  var portfolio1 = "img/portfolio-01.jpg";

  // | Images
  var logo = "img/logo.png";
  var heroBackground = "img/hero-bg.jpg";

  // | Fonts
  var googleRaleway = "https://fonts.googleapis.com/css?family=Raleway:300,400,700,900";
  var aboutBackground = "img/who-we-are.jpg";
  exports["googleRaleway"] = googleRaleway;
  exports["logo"] = logo;
  exports["portfolio1"] = portfolio1;
  exports["portfolio2"] = portfolio2;
  exports["portfolio3"] = portfolio3;
  exports["portfolio4"] = portfolio4;
  exports["portfolio5"] = portfolio5;
  exports["portfolio6"] = portfolio6;
  exports["heroBackground"] = heroBackground;
  exports["aboutBackground"] = aboutBackground;
})(PS["Urls"] = PS["Urls"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  ...
  var Urls = PS["Urls"];                 
  var root = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.homeAboutText)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Colors.mineshaft))(function () {
      return CSSUtils.padding1(CSS_Size.em(3.0));
  })))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.homeAboutTextBox)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.relative))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Border.border(CSS_Border.solid)(CSS_Size.px(2.0))(Colors.springgreen))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.padding(CSS_Size.em(2.0))(CSS_Size.em(2.0))(CSS_Size.nil)(CSS_Size.em(2.0)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.boxTitle)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.absolute))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.left(CSS_Size.nil))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.right(CSS_Size.nil))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.top(CSS_Size.em(-1.0)))(function () {
                                  return CSS_Stylesheet.select(CSS_Elements.h1)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.marginTop(CSS_Size.nil))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.inlineBlock))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.padding2(CSS_Size.nil)(CSS_Size.em(0.3)))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Colors.mineshaft))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(Colors.springgreen))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("font-weight")("300"))(function () {
                                                          return CSS_Font.fontSize(CSS_Size.rem(1.7));
                                                      });
                                                  });
                                              });
                                          });
                      ...
                      return CSS_Stylesheet.select(CSS_Elements.p)(CSS_Font.color(Colors.white));
                  });
              });
          });
      })))(function () {
          return CSSConfig.desktop(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.homeAbout)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundImage(CSS_Background.url(Urls.aboutBackground)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundPosition(CSS_Background.placed(CSS_Background.sideCenter)(CSS_Background.sideCenter)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundRepeat(CSS_Background.noRepeat))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.paddingBottom(CSS_Size.em(10.0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.relative))(function () {
                              return CSSUtils.padding1(CSS_Size.em(20.0));
                          });
                      });
                  });
              });
          })))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.homeAboutText)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.absolute))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.top(CSS_Size.em(-10.0)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.left(CSS_Size.em(3.0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(50.0)))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.minWidth(CSS_Size.rem(35.0)))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_TextAlign.textAlign(CSS_TextAlign.startTextAlign))(function () {
                                      return CSS_Box.boxShadow(CSS_Size.nil)(CSS_Size.nil)(CSS_Size.em(4.0))(Color.rgba(0)(0)(0)(0.5));
                                  });
                              });
                          });
                      });
                  ...
                  return CSS_Stylesheet.select(Selectors.homeAboutTextBox)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.padding(CSS_Size.em(5.0))(CSS_Size.em(3.0))(CSS_Size.em(2.0))(CSS_Size.em(5.0)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.boxTitle)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.paddingLeft(CSS_Size.em(5.0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.top(CSS_Size.em(-1.5)))(function () {
                              return CSS_Stylesheet.select(CSS_Elements.h1)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontSize(CSS_Size.rem(3.0)))(function () {
                                  return CSSUtils.padding2(CSS_Size.nil)(CSS_Size.em(0.6));
                              }));
                          });
                      })))(function () {
                          return CSS_Stylesheet.select(CSS_Elements.p)(CSS_Font.fontSize(CSS_Size.rem(1.5)));
                      });
                  }));
              });
          }));
...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];
  var Selectors = PS["Selectors"];                 
  var root = CSS_Stylesheet.select(Selectors.callToAction)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Colors.springgreen))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.padding2(CSS_Size.em(3.0))(CSS_Size.nil))(function () {
          return CSS_Stylesheet.select(CSS_Elements.h1)(CSS_Geometry.marginTop(CSS_Size.nil));
      });
  }));
  exports["root"] = root;
})(PS["CSSCTA"] = PS["CSSCTA"] || {});
(function(exports) {
  ...
  var Prelude = PS["Prelude"];
  var Selectors = PS["Selectors"];                 
  var root = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.footer)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Colors.mineshaft))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(Colors.white))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.padding1(CSS_Size.em(5.0)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.container)(CSS_Display.display(CSS_Display.block)))(function () {
                  return CSS_Stylesheet.select(Selectors.column1)(CSSUtils.margin1(CSS_Size.em(1.0)));
              });
          });
      });
  })))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSConfig.half(CSS_Stylesheet.select(CSS_Selector.deep(Selectors.footer)(Selectors.container))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.grid))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("grid-template-columns")("1fr 1fr 1fr"))(function () {
              return CSS_Stylesheet.select(Selectors.column3)(CSSUtils.pair("grid-column")("1 / 4"));
          });
      }))))(function () {
          return CSSConfig.desktop(CSS_Stylesheet.select(CSS_Selector.deep(Selectors.footer)(Selectors.container))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.grid))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("grid-template-columns")("3fr 1fr 1fr 1fr"))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("grid-column-gap")("3em"))(function () {
                      return CSS_Stylesheet.select(Selectors.column3)(CSSUtils.pair("grid-column")("1"));
                  });
              });
          })));
      });
...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];
  var Selectors = PS["Selectors"];                 
  var root = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.header)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.absolute))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.left(CSS_Size.nil))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.right(CSS_Size.nil))(function () {
      ...
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.nav)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.ul)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.margin1(CSS_Size.nil))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.padding1(CSS_Size.nil))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_ListStyle_Type.listStyleType(CSS_Common.none(CSS_ListStyle_Type.noneListTypeType)))(function () {
                  return CSS_Stylesheet.select(CSS_Elements.li)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.inlineBlock))(function () {
                      return CSSUtils.margin1(CSS_Size.em(1.0));
                  }));
              });
          });
      })))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.a)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("font-weight")("900"))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Text.textDecoration(CSS_Text.noneTextDecoration))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Text_Transform.textTransform(CSS_Text_Transform.uppercase))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontSize(CSS_Size.em(0.8)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.padding1(CSS_Size.em(0.5)))(function () {
                              return CSS_Font.color(Colors.white);
                          });
                      });
                  });
              });
          })))(function () {
              return CSS_Stylesheet.select(CSSUtils.combine(CSS_Selector["with"](CSS_Elements.a)(CSS_Pseudo.hover))(CSS_Selector["with"](CSS_Elements.a)(CSSUtils.focus)))(CSS_Font.color(Colors.lightgray));
          });
      })))(function () {
          return CSSConfig.desktop(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.logo)(CSS_Display["float"](CSS_Display.floatLeft)))(function () {
              return CSS_Stylesheet.select(CSS_Elements.nav)(CSS_Display["float"](CSS_Display.floatRight));
          }));
      });
  });
  exports["root"] = root;
})(PS["CSSHeader"] = PS["CSSHeader"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var CSS = PS["CSS"];
  ...
  var Selectors = PS["Selectors"];
  var Urls = PS["Urls"];                 
  var root = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.homeHero)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundImage(CSS_Background.url(Urls.heroBackground)))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundSize(CSS_Background.cover))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundPosition(CSS_Background.placed(CSS_Background.sideCenter)(CSS_Background.sideCenter)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.padding2(CSS_Size.em(10.0))(CSS_Size.nil))(function () {
                  return CSS_Font.color(Colors.white);
              });
          });
      });
  })))(function () {
      return CSSConfig.desktop(CSS_Stylesheet.select(Selectors.homeHero)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.vh(100.0)))(function () {
          return CSS_Geometry.paddingTop(CSS_Size.vh(35.0));
      })));
  });
  exports["root"] = root;
})(PS["CSSHero"] = PS["CSSHero"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var CSS = PS["CSS"];
  ...
  var Prelude = PS["Prelude"];
  var Selectors = PS["Selectors"];                 
  var root = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.portfolio)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.marginTop(CSS_Size.em(3.0)))(function () {
      return CSS_Stylesheet.select(CSS_Elements.h1)(CSSUtils.pair("font-weight")("300"));
  })))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.portfolioItem)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.relative))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.margin1(CSS_Size.nil))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Overflow.overflow(CSS_Overflow.hidden))(function () {
                  return CSS_Stylesheet.select(CSS_Elements.img)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.block))(function () {
                      return CSS_Geometry.width(CSS_Size.pct(100.0));
                  }));
              });
          });
      })))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.portfolioDescriptionBox)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.absolute))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.left(CSS_Size.nil))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.right(CSS_Size.nil))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.bottom(CSS_Size.em(2.0)))(function () {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.portfolioDescription)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(75.0)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.padding(CSS_Size.em(0.5))(CSS_Size.nil)(CSS_Size.em(1.0))(CSS_Size.nil))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Color.rgba(0)(0)(0)(0.6)))(function () {
                          return CSS_Font.color(Colors.white);
                      });
                  });
              })))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSConfig.half(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.portfolioList)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.grid))(function () {
                      return CSSUtils.pair("grid-template-columns")("1fr 1fr");
                  })))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.portfolioDescriptionBox)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.bottom(CSS_Size.nil))(function () {
                          return CSS_Transform.transform(CSSUtils.translate_(CSS_Size.nil)(CSS_Size.pct(150.0)));
                      })))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector.deep(CSS_Selector["with"](Selectors.portfolioItem)(CSS_Pseudo.hover))(Selectors.portfolioDescriptionBox))(CSS_Transform.transform(CSSUtils.translate_(CSS_Size.nil)(CSS_Size.nil))))(function () {
                              return CSS_Stylesheet.select(Selectors.portfolioDescription)(CSS_Geometry.width(CSS_Size.pct(100.0)));
                          });
                      });
                  })))(function () {
                      return CSSConfig.desktop(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.portfolioList)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.grid))(function () {
                          return CSSUtils.pair("grid-template-columns")("1fr 1fr 1fr");
                      })))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.portfolioDescriptionBox)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.bottom(CSS_Size.nil))(function () {
                              return CSS_Transform.transform(CSSUtils.translate_(CSS_Size.nil)(CSS_Size.pct(150.0)));
                          })))(function () {
  ...
  exports["root"] = root;
})(PS["CSSPortfolio"] = PS["CSSPortfolio"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var CSS = PS["CSS"];
  ...
  var CSS_Text_Transform = PS["CSS.Text.Transform"];
  var CSS_TextAlign = PS["CSS.TextAlign"];
  var CSSAbout = PS["CSSAbout"];
  var CSSCTA = PS["CSSCTA"];
  var CSSConfig = PS["CSSConfig"];
  var CSSFooter = PS["CSSFooter"];
  var CSSHeader = PS["CSSHeader"];
  var CSSHero = PS["CSSHero"];
  var CSSPortfolio = PS["CSSPortfolio"];
  var CSSUtils = PS["CSSUtils"];
  var Colors = PS["Colors"];
  var Control_Bind = PS["Control.Bind"];
  var Prelude = PS["Prelude"];
  var Selectors = PS["Selectors"];
  var Urls = PS["Urls"];                 
  var root = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.importUrl(Urls.googleRaleway))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector.star)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Box.boxSizing(CSS_Box.borderBox))(function () {
          return CSSUtils.pair("transition")("all ease-in-out 250ms");
      })))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.body)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.margin1(CSS_Size.nil))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("font-family")("'Raleway', sans-serif"))(function () {
                  return CSS_TextAlign.textAlign(CSS_TextAlign.center);
              });
          })))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.p)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.marginTop(CSS_Size.nil))(function () {
                  return CSS_Geometry.lineHeight(CSS_Size.em(1.5));
              })))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.img)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.maxWidth(CSS_Size.pct(100.0)))(function () {
                      return CSS_Geometry.height(CSS_Common.auto(CSS_Size.autoSize));
                  })))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.container)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(95.0)))(function () {
                          return CSSUtils.margin2(CSS_Size.nil)(CSS_Common.auto(CSS_Size.autoSize));
                      })))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.title)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontSize(CSS_Size.rem(2.5)))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.marginBottom(CSS_Size.em(1.5)))(function () {
                                  return CSS_Stylesheet.select(CSS_Elements.span)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("font-weight")("300"))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.block))(function () {
                                          return CSS_Font.fontSize(CSS_Size.em(0.9));
                                      });
                                  }));
                              });
                          })))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSConfig.desktop(CSS_Stylesheet.select(Selectors.title)(CSS_Font.fontSize(CSS_Size.rem(3.7)))))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.button)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.inlineBlock))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontSize(CSS_Size.rem(1.2)))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Text.textDecoration(CSS_Text.noneTextDecoration))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Text_Transform.textTransform(CSS_Text_Transform.uppercase))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("border-style")("solid"))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.borderWidth(CSS_Size.px(2.0)))(function () {
                                                          return CSSUtils.padding2(CSS_Size.em(0.5))(CSS_Size.em(1.75));
                                                      });
                                                  });
                                              });
                                          });
                                      ...
                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSConfig.desktop(CSS_Stylesheet.select(Selectors.button)(CSS_Font.fontSize(CSS_Size.rem(1.5)))))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.buttonAccent)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(Colors.springgreen))(function () {
                                              return CSS_Border.borderColor(Colors.springgreen);
                                          })))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.combine(CSS_Selector["with"](Selectors.buttonAccent)(CSS_Pseudo.hover))(CSS_Selector["with"](Selectors.buttonAccent)(CSSUtils.focus)))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Colors.springgreen))(function () {
                                                  return CSS_Font.color(Colors.mineshaft);
                                              })))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.buttonDark)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(Colors.mineshaft))(function () {
                                                      return CSS_Border.borderColor(Colors.mineshaft);
                                                  })))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.combine(CSS_Selector["with"](Selectors.buttonDark)(CSS_Pseudo.hover))(CSS_Selector["with"](Selectors.buttonDark)(CSSUtils.focus)))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Colors.mineshaft))(function () {
                                                          return CSS_Font.color(Colors.springgreen);
                                                      })))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.buttonSmall)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontSize(CSS_Size.rem(0.7)))(function () {
                                                              return CSSUtils.pair("font-weight")("700");
                                                          })))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSConfig.desktop(CSS_Stylesheet.select(Selectors.buttonSmall)(CSS_Font.fontSize(CSS_Size.rem(0.8)))))(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.unstyledList)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.margin1(CSS_Size.nil))(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.padding1(CSS_Size.nil))(function () {
                                                                          return CSS_ListStyle_Type.listStyleType(CSS_Common.none(CSS_ListStyle_Type.noneListTypeType));
                                                                      });
                                                                  })))(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSHeader.root)(function () {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSHero.root)(function () {
                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSAbout.root)(function () {
                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSPortfolio.root)(function () {
                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSCTA.root)(function () {
                                                                                          return CSSFooter.root;
                                                                                      });
                                                                                  });
                                                                              });
                                                                          });
...
(function(exports) {
  ...
  var render = function (v) {
      var portfolio = (function () {
          var portfolioItem = function (url) {
              return Halogen_HTML_Elements.figure([ HalogenUtils.classList([ ClassNames.portfolioItem ]) ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src(url), Halogen_HTML_Properties.alt("portfolio item") ]), Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.portfolioDescriptionBox ]) ])([ Halogen_HTML_Elements.figcaption([ HalogenUtils.classList([ ClassNames.portfolioDescription ]) ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Project title") ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(""), HalogenUtils.classList([ ClassNames.button, ClassNames.buttonAccent, ClassNames.buttonSmall ]) ])([ Halogen_HTML_Core.text("Project details") ]) ]) ]) ]);
          };
          return Halogen_HTML_Elements.section([ HalogenUtils.classList([ ClassNames.portfolio ]) ])([ Halogen_HTML_Elements.h1([ HalogenUtils.classList([ ClassNames.title ]) ])([ Halogen_HTML_Core.text("Some of our work") ]), Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.portfolioList ]) ])([ portfolioItem(Urls.portfolio1), portfolioItem(Urls.portfolio2), portfolioItem(Urls.portfolio3), portfolioItem(Urls.portfolio4), portfolioItem(Urls.portfolio5), portfolioItem(Urls.portfolio6) ]) ]);
      })();
      var hero = Halogen_HTML_Elements.section([ HalogenUtils.classList([ ClassNames.homeHero ]) ])([ Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.container ]) ])([ Halogen_HTML_Elements.h1([ HalogenUtils.classList([ ClassNames.title ]) ])([ Halogen_HTML_Core.text("Making things looks great"), Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("for companies who make great stuff") ]) ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("/projects"), HalogenUtils.classList([ ClassNames.button, ClassNames.buttonAccent ]) ])([ Halogen_HTML_Core.text("See Our Work") ]) ]) ]);
      var header = Halogen_HTML_Elements.header_([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src(Urls.logo), Halogen_HTML_Properties.alt(""), HalogenUtils.classList([ ClassNames.logo ]) ]), Halogen_HTML_Elements.nav_([ Halogen_HTML_Elements.ul_([ Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("/home") ])([ Halogen_HTML_Core.text("Home") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("/about") ])([ Halogen_HTML_Core.text("About") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("/contact") ])([ Halogen_HTML_Core.text("Contact") ]) ]) ]) ]) ]);
      var footer = (function () {
          var links = Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.column1 ]) ])([ Halogen_HTML_Elements.ul([ HalogenUtils.classList([ ClassNames.unstyledList ]) ])([ Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.strong_([ Halogen_HTML_Core.text("Shoreditch") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("Bag williamsburg") ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("Woke retro") ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("Readymade") ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("Scenester") ]) ]) ]);
          var description = Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.column3 ]) ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Shoreditch bespoke leggings, tote bag williamsburg woke retro readymade scenester brunch art party farm-to-table pug. Wayfarers lyft prism, edison bulb distillery pok pok narwhal pinterest poke.") ]) ]);
          return Halogen_HTML_Elements.footer([ HalogenUtils.classList([ ClassNames.footer ]) ])([ Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.container ]) ])([ description, links, links, links ]) ]);
      })();
      var callToAction = Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.callToAction ]) ])([ Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.container ]) ])([ Halogen_HTML_Elements.h1([ HalogenUtils.classList([ ClassNames.title ]) ])([ Halogen_HTML_Core.text("Like what you see?"), Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("Then what are you waiting for?") ]) ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(""), HalogenUtils.classList([ ClassNames.button, ClassNames.buttonDark ]) ])([ Halogen_HTML_Core.text("Hire us") ]) ]) ]);
      var aboutUs = Halogen_HTML_Elements.section([ HalogenUtils.classList([ ClassNames.homeAbout ]) ])([ Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.homeAboutText ]) ])([ Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.homeAboutTextBox ]) ])([ Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.boxTitle ]) ])([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Who we are") ]) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Sit by the fire drink water out of faucet hide head under blanket so no one can see cat is love, cat is life. Knock dish off table eating always hungry so favor packing over toy") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.strong_([ Halogen_HTML_Core.text("Rub face on owners.") ]), Halogen_HTML_Core.text(" Peer out window, chatter at birds, lure them to mouth. Chase ball of string eat a plant, kill a hand, i am the best have secret plans.") ]) ]) ]) ]);
      return Halogen_HTML_Elements.div_([ header, hero, aboutUs, portfolio, callToAction, footer, Halogen_HTML_CSS.stylesheet(CSSRoot.root) ]);
  };
