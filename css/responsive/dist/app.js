...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];
  var Selectors = PS["Selectors"];                 
  var root = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.portfolio)(CSSUtils.margin2(CSS_Size.em(3.0))(CSS_Size.nil)))(function () {
...
(function(exports) {
  ...
  var render = function (v) {
      ...
      var footer = (function () {
          ...
          return Halogen_HTML_Elements.footer_([ description, links, links, links ]);
      })();
      ...
      return Halogen_HTML_Elements.div_([ header, hero, aboutUs, portfolio, footer, Halogen_HTML_CSS.stylesheet(CSSRoot.root) ]);
  };
