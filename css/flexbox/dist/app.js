...
(function(exports) {
  ...
  var flexboxExample = (function () {
      var flexboxExampleSection2 = Halogen_HTML_Elements.section([ HalogenUtils.classList([ ClassNames.elemYellow ]) ])([ Halogen_HTML_Elements.span([ HalogenUtils.classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<section>") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum interdum, nisi lorem egestas odio, vitae scelerisque enim ligula venenatis dolor. Maecenas nisl est, ultrices nec congue eget, auctor vitae massa. Fusce luctus vestibulum augue ut aliquet. Mauris ante ligula, facilisis sed ornare eu, lobortis in odio. Praesent convallis urna a lacus interdum ut hendrerit risus congue. Nunc sagittis dictum nisi, sed ullamcorper ipsum dignissim ac. In at libero sed nunc venenatis imperdiet sed ornare turpis. Donec vitae dui eget tellus gravida venenatis. Integer fringilla congue eros non fermentum. Sed dapibus pulvinar nibh tempor porta. Cras ac leo purus. Mauris quis diam velit.") ]), Halogen_HTML_Elements.span([ HalogenUtils.classList([ ClassNames.endLabel ]) ])([ Halogen_HTML_Core.text("</section>") ]) ]);
      var flexboxExampleSection1 = Halogen_HTML_Elements.section([ HalogenUtils.classList([ ClassNames.elemYellow ]) ])([ Halogen_HTML_Elements.span([ HalogenUtils.classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<section>") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("The "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("margin-left") ]), Halogen_HTML_Core.text(" style for "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("section") ]), Halogen_HTML_Core.text("s makes sure there is room for the "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("nav") ]), Halogen_HTML_Core.text(". Otherwise, the absolute and static elements would overlap") ]), Halogen_HTML_Elements.span([ HalogenUtils.classList([ ClassNames.endLabel ]) ])([ Halogen_HTML_Core.text("</section>") ]) ]);
      var flexboxExampleNav = Halogen_HTML_Elements.nav([ HalogenUtils.classList([ "nav", ClassNames.elemRed ]) ])([ Halogen_HTML_Elements.span([ HalogenUtils.classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<nav>") ]), Halogen_HTML_Elements.ul_([ Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(".") ])([ Halogen_HTML_Core.text("Home") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(".") ])([ Halogen_HTML_Core.text("Taco Menu") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(".") ])([ Halogen_HTML_Core.text("Draft List") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(".") ])([ Halogen_HTML_Core.text("Hours") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(".") ])([ Halogen_HTML_Core.text("Directions") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(".") ])([ Halogen_HTML_Core.text("Contact") ]) ]) ]), Halogen_HTML_Elements.span([ HalogenUtils.classList([ ClassNames.endLabel ]) ])([ Halogen_HTML_Core.text("</nav>") ]) ]);
      return Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.container, ClassNames.elem ]) ])([ Halogen_HTML_Elements.span([ HalogenUtils.classList([ ClassNames.label ]) ])([ Halogen_HTML_Core.text("<div class=\"container\">") ]), flexboxExampleNav, Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.flexColumn ]) ])([ flexboxExampleSection1, flexboxExampleSection2 ]) ]);
  })();
  var render = function (v) {
      return Halogen_HTML_Elements.div_([ flexboxExample ]);
  };
  var $$eval = function (v) {
  ...
  exports["flexboxExample"] = flexboxExample;
