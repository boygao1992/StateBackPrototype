...
(function(exports) {
  ...
  var unitless = function ($17) {
      return CSS_Size.Size(CSS_Property.value(CSS_Property.valNumber)($17));
  };
  ...
  var byClass = function ($23) {
      return CSS_Selector.Refinement(Control_Applicative.pure(Control_Applicative.applicativeArray)(CSS_Selector.Class.create($23)));
  };
...
(function(exports) {
  ...
  var mediumGray = CSSUtils.safeFromHexString("#737373");
  var lightGray = CSSUtils.safeFromHexString("#c4c4c4");
  var gray = CSSUtils.safeFromHexString("#4f4f4f");
  var black = CSSUtils.safeFromHexString("#353535");
  exports["black"] = black;
  exports["gray"] = gray;
  exports["mediumGray"] = mediumGray;
...
(function(exports) {
  ...
  var menuFontColor = Colors.mediumGray;
  var menuBackgroundColor = Colors.gray;
  var menuActiveColor = Colors.lightGray;
  var mainFontColor = Colors.lightGray;               
  var fontBold = CSSUtils.pair("font-weight")("700");
  var bodyBackgroundColor = Colors.black;
  var accent = Colors.orange;
  exports["accent"] = accent;
  exports["bodyBackgroundColor"] = bodyBackgroundColor;
  exports["menuBackgroundColor"] = menuBackgroundColor;
  exports["mainFontColor"] = mainFontColor;
  exports["menuActiveColor"] = menuActiveColor;
  exports["menuFontColor"] = menuFontColor;
  exports["fontBold"] = fontBold;
})(PS["CSS.Config"] = PS["CSS.Config"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var CSS_Common = PS["CSS.Common"];
...
(function(exports) {
    "use strict";
  var googleRaleway = "https://fonts.googleapis.com/css?family=Raleway:300,700";
...
(function(exports) {
  ...
  var root = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.importUrl(Urls.googleRaleway))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector.star)(CSS_Box.boxSizing(CSS_Box.borderBox)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.body)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(CSS_Config.bodyBackgroundColor))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(CSS_Config.mainFontColor))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("font-family")("'Raleway', sans-serif"))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontSize(CSS_Size.rem(1.2)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.lineHeight(CSSUtils.unitless(1.45)))(function () {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.sidebar)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(CSS_Config.menuBackgroundColor))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.flexGrow(1))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.flexShrink(1))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.flexBasis(CSS_Size.pct(20.0)))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.minWidth(CSS_Size.px(300.0)))(function () {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.logo)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Text_Transform.textTransform(CSS_Text_Transform.uppercase))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.marginBottom(CSS_Size.em(2.0)))(function () {
                          return CSS_Stylesheet.select(CSS_Elements.span)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.padding2(CSS_Size.nil)(CSS_Size.em(0.2)))(function () {
                              return CSS_Config.fontBold;
                          }));
                      });
                  })))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.navItem)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(CSS_Config.menuFontColor))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Text.textDecoration(CSS_Text.noneTextDecoration))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontSize(CSS_Size.rem(1.7)))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.inlineBlock))(function () {
                                      return CSS_Geometry.marginRight(CSS_Size.em(2.0));
                                  });
                              });
                          });
                      })))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](Selectors.navItem)(CSSUtils.byClass(ClassNames.active)))(CSS_Font.color(CSS_Config.menuActiveColor)))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.content)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.padding1(CSS_Size.pct(10.0)))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.flexGrow(1))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.flexShrink(1))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.flexBasis(CSS_Size.pct(80.0)))(function () {
                                              return CSS_Geometry.minHeight(CSS_Size.vh(100.0));
                                          });
                                      });
                                  });
                              })))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.portfolio)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.grid))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.pct(100.0)))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("grid-template-rows")("repeat(8, 1fr)"))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("grid-template-columns")("repeat(5, 1fr)"))(function () {
                                                  return CSSUtils.pair("grid-gap")("20px");
                                              });
                                          });
                                      });
                                  })))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.portfolioItem)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(CSS_Config.accent))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(Colors.lightGray))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Config.fontBold)(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.flex))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.justifyContent(CSS_Common.center(CSS_Flexbox.centerJustifyContentValue)))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.alignItems(CSS_Common.center(CSS_Flexbox.centerAlignItemsValue)))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontSize(CSS_Size.em(1.5)))(function () {
                                                                  return CSS_Background.backgroundSize(CSS_Background.cover);
                                                              });
                                                          });
                                                      });
                                                  });
                                          ...
                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](Selectors.portfolioItem)(CSSUtils.byClass(ClassNames.small)))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("grid-row")("span 1"))(function () {
                                              return CSSUtils.pair("grid-column")("span 1");
                                          })))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](Selectors.portfolioItem)(CSSUtils.byClass(ClassNames.medium)))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("grid-row")("span 2"))(function () {
                                                  return CSSUtils.pair("grid-column")("span 2");
                                              })))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](Selectors.portfolioItem)(CSSUtils.byClass(ClassNames.large)))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("grid-row")("span 3"))(function () {
                                                      return CSSUtils.pair("grid-column")("span 3");
                                                  })))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](Selectors.portfolioItem)(CSSUtils.byClass(ClassNames.tall)))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("grid-row")("span 3"))(function () {
                                                          return CSSUtils.pair("grid-column")("span 2");
                                                      })))(function () {
                                                          return CSS_Stylesheet.select(CSS_Selector["with"](Selectors.portfolioItem)(CSSUtils.byClass(ClassNames.wide)))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("grid-row")("span 2"))(function () {
                                                              return CSSUtils.pair("grid-column")("span 3");
                                                          }));
                                                      });
                                                  });
...
(function(exports) {
  ...
  var render = function (state) {
      var sidebar = Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.sidebar ]) ])([ Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.logo ]) ])([ Halogen_HTML_Core.text("Mosaic"), Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("Grid") ]) ]), Halogen_HTML_Elements.nav_([ Halogen_HTML_Elements.a([ HalogenUtils.classList([ ClassNames.navItem ]), Halogen_HTML_Properties.href("") ])([ Halogen_HTML_Core.text("Home") ]), Halogen_HTML_Elements.a([ HalogenUtils.classList([ ClassNames.navItem ]), Halogen_HTML_Properties.href("") ])([ Halogen_HTML_Core.text("About") ]), Halogen_HTML_Elements.a([ HalogenUtils.classList([ ClassNames.navItem, ClassNames.active ]), Halogen_HTML_Properties.href("") ])([ Halogen_HTML_Core.text("Portfolio") ]), Halogen_HTML_Elements.a([ HalogenUtils.classList([ ClassNames.navItem ]), Halogen_HTML_Properties.href("") ])([ Halogen_HTML_Core.text("Contact") ]) ]) ]);
      var content = (function () {
          var portfolioItem = function (title) {
              return function (classNames) {
                  return Halogen_HTML_Elements.div([ HalogenUtils.classList(Data_Array.cons(ClassNames.portfolioItem)(classNames)) ])([ Halogen_HTML_Core.text(title) ]);
              };
          };
          return Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.content ]) ])([ Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.portfolio ]) ])([ portfolioItem("one")([ ClassNames.medium ]), portfolioItem("two")([ ClassNames.large, ClassNames.two ]), portfolioItem("three")([ ClassNames.medium ]), portfolioItem("four")([ ClassNames.small ]), portfolioItem("five")([ ClassNames.tall ]), portfolioItem("six")([ ClassNames.wide ]) ]) ]);
      })();
      return Halogen_HTML_Elements.div_([ sidebar, content, Halogen_HTML_CSS.stylesheet(CSS_Root.root) ]);
  };
