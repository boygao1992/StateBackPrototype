...
(function(exports) {
  ...
  var isStringJustifyContentValue = new CSS_String.IsString(function ($84) {
      return JustifyContentValue(CSS_String.fromString(CSS_Property.isStringValue)($84));
  });                                                                                                                         
  var isStringAlignSelfValue = new CSS_String.IsString(function ($85) {
      return AlignSelfValue(CSS_String.fromString(CSS_Property.isStringValue)($85));
  });                                                                                               
  var isStringAlignItemsValue = new CSS_String.IsString(function ($86) {
      return AlignItemsValue(CSS_String.fromString(CSS_Property.isStringValue)($86));
  });                                                                                     
  ...
  exports["centerAlignSelfValue"] = centerAlignSelfValue;
...
(function(exports) {
  ...
  var light = CSSUtils.safeFromHexString("#EBF5EE");
  var dark = CSSUtils.safeFromHexString("#2F4858");
  var accent = CSSUtils.safeFromHexString("#F6AE2D");
...
(function(exports) {
  ...
  var table = CSSUtils.class_(ClassNames.table);
  var section = CSSUtils.class_(ClassNames.section);
  var margins = CSSUtils.class_(ClassNames.margins);
  var grid = CSSUtils.class_(ClassNames.grid);
  var flexbox = CSSUtils.class_(ClassNames.flexbox);

  // | id selectors
  // | class selectors
  var content = CSSUtils.class_(ClassNames.content);
  var alignSelf = CSSUtils.class_(ClassNames.alignSelf);
  var absolute = CSSUtils.class_(ClassNames.absolute);
  exports["content"] = content;
  exports["section"] = section;
  exports["title"] = title;
  exports["table"] = table;
...
(function(exports) {
  ...
  var root = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.body)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontSize(CSS_Size.rem(2.0)))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Colors.dark))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(Colors.light))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Text.letterSpacing(CSS_Size.px(2.0)))(function () {
                  return CSS_TextAlign.textAlign(CSS_TextAlign.center);
              });
          });
      });
  })))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.p)(CSSUtils.margin1(CSS_Size.nil)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.content)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.grid))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("grid-template-columns")("1fr minmax(250px, 500px) 1fr"))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("grid-auto-rows")("auto"))(function () {
                      return CSS_Stylesheet.select(CSS_Selector.child(CSS_Elements.div)(CSS_Elements.div))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.vh(80.0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.margin2(CSS_Size.vh(10.0))(CSS_Size.nil))(function () {
                              return CSS_Border.border(CSS_Border.solid)(CSS_Size.px(5.0))(Colors.accent);
                          });
                      }));
                  });
              });
          })))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector.child(Selectors.content)(CSS_Selector.star))(CSSUtils.pair("grid-column")("2")))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.section)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.grid))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("grid-template-columns")("1fr minmax(250px, 500px)"))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("grid-auto-rows")("auto"))(function () {
                              return CSS_Stylesheet.select(CSS_Elements.div)(CSSUtils.pair("grid-column")("2"));
                          });
                      });
                  })))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.title)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("grid-column")("1"))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSSUtils.pair("writing-mode")("vertical-lr"))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.margin(CSS_Size.nil)(CSS_Size.em(0.5))(CSS_Size.nil)(CSS_Common.auto(CSS_Size.autoSize)))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.paddingLeft(CSS_Size.em(1.0)))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(Colors.accent))(function () {
                                          return CSSUtils.pair("opacity")("0.35");
                                      });
                                  });
                              });
                          });
                      })))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.table)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.table))(function () {
                              return CSS_Stylesheet.select(CSS_Elements.p)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.tableCell))(function () {
                                  return CSS_VerticalAlign.verticalAlign(CSS_VerticalAlign.Middle.value);
                              }));
                          })))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.absolute)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.relative))(function () {
                                  return CSS_Stylesheet.select(CSS_Elements.p)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.absolute))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.top(CSS_Size.pct(50.0)))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(100.0)))(function () {
                                              return CSS_Transform.transform(CSSUtils.translate_(CSS_Size.nil)(CSS_Size.pct(-50.0)));
                                          });
                                      });
                                  }));
                              })))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSSUtils.combine(Selectors.flexbox)(Selectors.grid))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.flex))(function () {
                                      ...
                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.margins)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.flex))(function () {
                                          return CSS_Stylesheet.select(CSS_Elements.p)(CSSUtils.margin1(CSS_Common.auto(CSS_Size.autoSize)));
                                      })))(function () {
                                          return CSS_Stylesheet.select(Selectors.alignSelf)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.flex))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.justifyContent(CSS_Common.center(CSS_Flexbox.centerJustifyContentValue)))(function () {
                                                  return CSS_Stylesheet.select(CSS_Elements.p)(CSS_Flexbox.alignSelf(CSS_Common.center(CSS_Flexbox.centerAlignSelfValue)));
                                              });
                                          }));
                                      });
                                  });
...
(function(exports) {
  ...
  var render = function (v) {
      return Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.content ]) ])([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Vertically centering with CSS") ]), Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.section ]) ])([ Halogen_HTML_Elements.h2([ HalogenUtils.classList([ ClassNames.title ]) ])([ Halogen_HTML_Core.text("table") ]), Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.table ]) ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("\x0a.table {\x0a  display: table\x0a}\x0a.table p {\x0a  display: tabel-cell\x0a  vertical-align: center;\x0a}\x0a          ") ]) ]) ]), Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.section ]) ])([ Halogen_HTML_Elements.h2([ HalogenUtils.classList([ ClassNames.title ]) ])([ Halogen_HTML_Core.text("absolute") ]), Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.absolute ]) ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("\x0a.absolute {\x0a  position: relative;\x0a}\x0a.absolute p {\x0a  position: absolute;\x0a  top: 50%;\x0a  width: 100%;\x0a  transform: translateY(-50%);\x0a}\x0a          ") ]) ]) ]), Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.section ]) ])([ Halogen_HTML_Elements.h2([ HalogenUtils.classList([ ClassNames.title ]) ])([ Halogen_HTML_Core.text("flexbox") ]), Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.flexbox ]) ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("\x0a.flexbox {\x0a  display: flex;\x0a  align-items: center;\x0a  justify-content: center;\x0a}\x0a          ") ]) ]) ]), Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.section ]) ])([ Halogen_HTML_Elements.h2([ HalogenUtils.classList([ ClassNames.title ]) ])([ Halogen_HTML_Core.text("grid") ]), Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.grid ]) ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("\x0a.grid {\x0a  display: gird;\x0a  align-items: center;\x0a  justify-content: center;\x0a}\x0a          ") ]) ]) ]), Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.section ]) ])([ Halogen_HTML_Elements.h2([ HalogenUtils.classList([ ClassNames.title ]) ])([ Halogen_HTML_Core.text("margins") ]), Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.margins ]) ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("\x0a.margin {\x0a  display: flex;\x0a}\x0a.margin p {\x0a  margin: auto;\x0a}\x0a          ") ]) ]) ]), Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.section ]) ])([ Halogen_HTML_Elements.h2([ HalogenUtils.classList([ ClassNames.title ]) ])([ Halogen_HTML_Core.text("align-self") ]), Halogen_HTML_Elements.div([ HalogenUtils.classList([ ClassNames.alignSelf ]) ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("\x0a.align-self {\x0a  display: flex;\x0a  justify-content: center;\x0a}\x0a.align-self p {\x0a  align-self: center;\x0a}\x0a          ") ]) ]) ]), Halogen_HTML_CSS.stylesheet(CSSRoot.root) ]);
  };
